  ...
  return (
    <header className="w-full flex flex-col gap-8 sm:flex-row justify-between">
      ...
      <div className="flex items-center shadow-md rounded-md w-64 self-end" onClick={() => {
        ...
        <input className="w-28 px-2 py-2 outline-none text-xs text-gray-700" />
        <input className="border-x border-gray-300 outline-none w-24 text-xs px-4 py-3 text-gray-700" placeholder="Add guests"  type="text" />
